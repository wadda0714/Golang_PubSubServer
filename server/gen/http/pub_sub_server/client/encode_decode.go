...
func (c *Client) BuildSendMessageRequest(ctx context.Context, v interface{}) (*http.Request, error) {
	var (
		roomName string
		message  string
	)
...
// body should be restored after having been read.
func DecodeSendMessageResponse(decoder func(*http.Response) goahttp.Decoder, restoreBody bool) func(*http.Response) (interface{}, error) {
	return func(resp *http.Response) (interface{}, error) {
		if restoreBody {
			b, err := ioutil.ReadAll(resp.Body)
			if err != nil {
